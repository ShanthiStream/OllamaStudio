...
let prevDiskStats = { readSpeed: 0, writeSpeed: 0, time: Date.now() };
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`Ollama Studio System Monitor API running on http://0.0.0.0:${PORT}`);
  console.log(`Detected: ${isAppleSilicon() ? 'Apple Silicon' : 'Intel/Other'} on ${os.platform()}`);
});
