...
import { Search, Brain, HardDrive, Gauge, Star, Trash2, MoreVertical, RefreshCw, Box, Download, Server, Activity } from 'lucide-react';
import { PageHeader } from '@/components/shared/PageHeader';
import { StatCard } from '@/components/shared/StatCard';
import { useOllamaModels, useDeleteModel, useOllamaStatus, useOllamaRunningModels } from '@/hooks/useOllama';
...
export default function Dashboard() {
  ...
  const { data: models, isLoading: modelsLoading, refetch } = useOllamaModels();
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border/30 pb-3 select-none">
                          ...
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem onClick={(e) => { e.preventDefault(); handleFavorite(model.name); }}>
                                  <Star className="w-4 h-4 mr-2" />
                                  {mounted && isFavorite(model.name) ? 'Unfavorite' : 'Favorite'}
                                </DropdownMenuItem>
                                <DropdownMenuItem className="text-destructive" onClick={(e) => { e.preventDefault(); handleDelete(model.name); }}>
